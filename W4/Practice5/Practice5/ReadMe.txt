...
Practice5Doc.h, Practice5Doc.cpp - 문서
    이 파일에는 CPractice5Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CPractice5Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Practice5View.h, Practice5View.cpp - 문서 뷰
    이 파일에는 CPractice5View 클래스가 들어 있습니다.
    CPractice5View 개체는 CPractice5Doc 개체를 보는 데 사용됩니다.
