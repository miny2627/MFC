...
응용 프로그램 마법사에서 이 Practice6_2 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 Practice6_2 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Practice6_2.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CPractice6_2App 응용 프로그램
    클래스를 선언합니다.

Practice6_2.cpp
    응용 프로그램 클래스 CPractice6_2App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Practice6_2.ico
    ...
    주 리소스 파일인 Practice6_2.rc에 의해 포함됩니다.
...
Practice6_2Doc.h, Practice6_2Doc.cpp - 문서
    이 파일에는 CPractice6_2Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CPractice6_2Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Practice6_2View.h, Practice6_2View.cpp - 문서 뷰
    이 파일에는 CPractice6_2View 클래스가 들어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Practice6_2.pch와
