...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0,0,RUNTIME_CLASS(CLeftViewDlg),CSize(400,400),pContext);
	m_wndSplitter.CreateView(0,1,RUNTIME_CLASS(CExercise10_1View),CSize(800,400),pContext);
